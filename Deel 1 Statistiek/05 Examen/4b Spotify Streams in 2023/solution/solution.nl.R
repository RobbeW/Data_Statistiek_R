...
hist(data$mil_streams[taylor_swift], breaks = aantal_staven, col = "coral", main = "Aantal Spotify streams van Taylor Swift in 2023", xlab = "Aantal Streams (x 1.000.000)", ylab = "Aantal Nummers")