...
- Bereken het totaal aantal streams (in miljoenen) van deze liedjes in de variabele `totaal`.
...
![Aantal Spotify streams in 2023.](media/plot.png "Aantal Spotify streams in 2023."){:data-caption="Aantal Spotify streams in 2023." .light-only width="480px"}

![Aantal Spotify streams in 2023.](media/plot_dark.png "Aantal Spotify streams in 2023."){:data-caption="Aantal Spotify streams in 2023." .dark-only width="480px"}
