...
# generate test data
cases = []
cases.append( ['def f( x ) : return 1/20*(x**5+3*x**4-11*x**3-27*x**2+10*x+70)',1,2, 0.0001])
cases.append( ['def f( x ) : return 1/20*(x**5+3*x**4-11*x**3-27*x**2+10*x+70)',2,3, 0.0001])
cases.append( ['def f( x ) : return 1/20*(x**5+3*x**4-11*x**3-27*x**2+10*x+70)',-5,-2, 0.0001])
cases.append( ['def f( x ) : return 2*x - 3', -1.1, 3.15,0.01])
...
for i in range(len(cases)):
    ...
    expression_name = 'regula_falsi( {}, {}, f, {} )'.format( test[1], test[2], test[3] )
    ...
    try:
        ...
        with contextlib.redirect_stdout(outputF):
            result = module.regula_falsi( test[1], test[2],f, test[3] )
