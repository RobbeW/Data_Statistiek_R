...
cases = [[1, 3, 4, 4],
         ...
         [3, 6, 9, 12],
         [20, 71, 79, 88, 97, 105],
         [6, 9, 35, 79, 101, 119, 141, 197],
         [36, 80, 90, 134, 148, 155, 156, 167, 176, 180],
         [40, 58, 114, 132],
         [1, 2, 3, 4, 5, 723]]

while len(cases) < ntests:
    n = random.randint(2, 100)
    case = [random.randint(1, 200) for _ in range(n)]
...
for i in range(len(cases)):
    ...
    expression_name = f"perfecte_koor({test})"
    ...
    try:
        ...
        with contextlib.redirect_stdout(outputF):
            result = module.perfecte_koor(test)
