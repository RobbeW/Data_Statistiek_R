...
\begin{document}
	\begin{tikzpicture}[
		...
		\matrix[Vector] at (0,0) (M){ % Matrix contents  
			{\color{BurntOrange}\faHome} & {\color{BurntOrange}\faHome} &  {\color{BurntOrange}\faHome} & {\color{LimeGreen}\faHome} &  {\color{BurntOrange}\faHome} &  {\color{BurntOrange}\faHome} &  {\color{BurntOrange}\faHome} \\
		};
