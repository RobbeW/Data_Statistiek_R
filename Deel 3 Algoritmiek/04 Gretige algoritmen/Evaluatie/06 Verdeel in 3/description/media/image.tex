...
\begin{document}
	\begin{tikzpicture}[
		...
		\matrix[Vector] at (0,0) (M){ % Matrix contents  
			\sf 0 & \sf 2 & \sf 1 & \sf -6 & \sf 6 & \sf -7 & \sf 9 & \sf 1 & \sf 2 & \sf 0 & \sf 1\\
		};
	
		\begin{scope}[on background layer] 
			%To delimit internal area groups
			%\node[DA,blue,fit=(M-3-2)(M-5-4)](subM-2){};
			\node[DA,BurntOrange,fit=(M-1-1)(M-1-3)](subM-1){};
			\node[DA,PineGreen,fit=(M-1-4)(M-1-8)](subM-2){};
			\node[DA,NavyBlue,fit=(M-1-9)(M-1-11)](subM-3){};
			
			% For line sectors
			%\draw[DG,BurntOrange](M-1-1.west) --(M-1-3.east);   
