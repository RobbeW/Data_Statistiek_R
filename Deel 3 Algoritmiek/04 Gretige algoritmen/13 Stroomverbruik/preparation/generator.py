...
cases = [[(7, 1), (5, 1), (3, 1)],
         ...
         [(10, 6), (4, 1), (3, 3), (1, 4)],
         [(5, 4), (1, 4)],
         [(10,6), (9, 1), (8,8), (6, 3), (4, 8)],
         [(7,14), (4,9), (2, 13), (1,11)]]


while len(cases) < ntests:
    n = random.randint(2, 50)
    choices = random.sample( list(range(1,10*n)), k = n)
    choices.sort(reverse = True)
    
    case = []
    for choice in choices:
        n = random.randint(1,10)
        case.append( (choice, n))
...
for i in range(len(cases)):
    ...
    expression_name = f"maximale_stroom({test})"
    ...
    try:
        ...
        with contextlib.redirect_stdout(outputF):
            result = module.maximale_stroom(test)
