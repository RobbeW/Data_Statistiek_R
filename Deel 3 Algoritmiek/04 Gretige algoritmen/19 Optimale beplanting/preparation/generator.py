...
while len(cases) < ntests:
    ...
    seedling = [ random.randint(10,1000) for _ in range(n)]
...
for i in range(len(cases)):
    ...
    expression_name = f"optimale_beplanting({test})"
    ...
    try:
        ...
        with contextlib.redirect_stdout(outputF):
            result = module.optimale_beplanting(test)
