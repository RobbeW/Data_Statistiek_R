...
\begin{document}
	\begin{tikzpicture}[main, line join=bevel]
		...
		\node[thick, main] (C) [below left of=B] {\parbox{1.75cm}{\centering halte \texttt{2}\\ eindhalte}}; 
		...
		\draw [thick, main, BurntOrange] (B) edge[bend left, track] node [below right, xshift=0.25cm, yshift=-0.25cm] {\textbf{2}} (C); 
